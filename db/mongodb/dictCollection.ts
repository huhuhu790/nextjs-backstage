...
export async function createDictSingle(data: DictDrawerDataType, userId: string) {
    return await mongoConnection(async (db) => {
...
export async function updateDictSingle(data: DictDrawerDataType, userId: string) {
    return await mongoConnection(async (db) => {
...
export async function updateDictValueSingle(data: DictValueDrawerDataType, userId: string) {
    return await mongoConnection(async (db) => {
...
export async function deleteDictSingle(id: string, userId: string) {
    return await mongoConnection(async (db) => {
