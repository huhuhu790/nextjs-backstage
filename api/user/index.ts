...
export async function getUserByOption(body: getUserOption, message: MessageInstance) {
...
export async function addUser(formData: FormData, message: MessageInstance) {
    return await fetchFormdata<LocalUser>('/api/system/user/addUserSingle', formData, message)
}

export async function updateUserSingle(formData: FormData, message: MessageInstance) {
    return await fetchFormdata<LocalUser>('/api/system/user/updateUserSingle', formData, message)
}
...
export async function updateUserOwnData(formData: FormData, message: MessageInstance) {
    return await fetchFormdata<LocalUser>('/api/system/user/updateUserOwnData', formData, message)
}
